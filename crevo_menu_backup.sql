...
CREATE DATABASE IF NOT EXISTS `u361157364_menudb`;
USE `u361157364_menudb`;
...
CREATE TABLE `audit_logs` (
  ...
  `actor_type` enum('admin','employee','system') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system',
  `action` enum('create','update','delete','approve','refresh','export') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `categories` (
  ...
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `scope` enum('menu','studio') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'menu',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `employees` (
  ...
  `role` enum('manager','waiter','cashier','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiter',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `expenses` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int DEFAULT NULL,
  `category` enum('operational','food','employee','marketing','utility','maintenance','other') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `offer_groups` (
  ...
  `selection_mode` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'checkbox',
...
CREATE TABLE `offers` (
  ...
  `name_ar` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_en` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `note_ar` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `note_en` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `order_items` (
  ...
  `item_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product',
  ...
  `display_image_url` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `source` enum('qr','app','phone','walk_in') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'qr',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `product_reactions` (
  ...
  `customer_id` int DEFAULT NULL,
  `product_id` int NOT NULL,
  `reaction` enum('liked','disliked','shared') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `products` (
  ...
  `cover_media_url` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tables` (
  ...
  `qr_code_uuid` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `table_color` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_phone` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `waiter_calls` (
  ...
  `table_id` int NOT NULL,
  `waiter_id` int DEFAULT NULL,
  `status` enum('pending','acknowledged','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
-- Dump completed on 2026-06-27  2:40:37
