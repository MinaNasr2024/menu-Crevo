...
export function HeroSection({ settings, language = 'ar' }) {
  ...
  return (
    <section className="overflow-hidden rounded-[28px] bg-[var(--site-surface)] shadow-[0_22px_70px_rgba(0,0,0,0.08)]">
      <div className="relative h-[420px] w-full md:h-[520px]">
        ...
        <div className="absolute inset-x-0 top-5 flex justify-end px-4 md:top-6 md:px-8">
          <button
            type="button"
            className="rounded-full border border-white/25 bg-black/30 px-5 py-3 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(0,0,0,0.2)] backdrop-blur-sm"
          >
            رجوع
          </button>
        </div>

        <div className="absolute inset-x-0 bottom-0 flex justify-center px-4 pb-6 md:pb-8">
          <div className="site-card w-full max-w-[1500px] rounded-[32px] border bg-white px-5 py-5 shadow-[0_20px_60px_rgba(0,0,0,0.14)] md:px-7 md:py-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="text-right">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2 text-sm font-semibold text-[var(--site-muted)]">
                    <span>لم يتم التقييم بعد</span>
                    {settings?.phone ? <span className="rounded-full bg-black/5 px-3 py-1 text-[var(--site-text)]">{settings.phone}</span> : null}
                  </div>
                </div>
              </div>
